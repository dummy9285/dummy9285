		...
		'<div class="col-lg-12 mx-auto">
			<div class="parent panel panel-info">
					...
					<div class="options panel-footer text-center">
							<input id="submit" class="btn btn-sm btn-outline-success" type="submit" name="submit" value="Save" onclick="return confirm(\'Are you sure to save given schedule on '.$day[$i].'? This will be permanent. You need to ask the admin if you want to change your availability schedule.\')">
							<button class="btn btn-sm btn-outline-danger" onclick="return confirm(\'Are you sure to clear table on '.$day[$i].'?\')">Clear</button>
					</div>
					</form>
			</div>
		</div>';
