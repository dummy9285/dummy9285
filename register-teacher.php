		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Sign up complete!</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<!-- <span aria-hidden="true">&times;</span> -->
					</button>
				</div>
				<div class="modal-body">
					<p class="card-text">Congratulation</p>
					<p class="card-text">You have successfully signed up for YahwehEnglishSchool.</p>
				</div>
				<div class="modal-footer">
					<a class="btn btn-primary" href="teacher/profile-information.php">Done</a>
